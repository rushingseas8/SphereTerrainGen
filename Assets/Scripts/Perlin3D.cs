...
{
    // 256 random vectors
    private static readonly float[] Vectors = {
    ...
    public float GetValue(float x, float y, float z, int octaves) {
        float value = 0.0f;
        ...
        {
            value += multiplier * GetValue(x, y, z);
    ...
    private const int MultiplierX = 1619;
    private const int MultiplierY = 31337;
    private const int MultiplierZ = 6971;
    private const int MultiplierSeed = 1013;
    private const int ValueShift = 8;
    ...
    Vector3 GetRandomVector(int x, int y, int z)
    {
        ...
        int vectorIndex = (
           ...
           + MultiplierY * y
           + MultiplierZ * z
           + MultiplierSeed * m_Seed)
           & 0x7fffffff;
        vectorIndex = (((vectorIndex >> ValueShift) ^ vectorIndex) & 0xff) * 3;
