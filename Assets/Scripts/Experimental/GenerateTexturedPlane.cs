...
/// <summary>
/// Generates a textured plane, which demonstrates the terrain atlas feature of
/// Unity. The shader does most of the useful work.
/// </summary>
public class GenerateTexturedPlane : MonoBehaviour {
